...
# patched version of pyipp
# includes support for IPP collections and more robust error handling
    ...
    if attribute["tag"] in (IppTag.ENUM.value, IppTag.INTEGER.value):
        ...
        if (
            ...
            try:
                ...
                _LOGGER.warning(f'Warning: enum {enum_class} has no value for {attribute["value"]}')
